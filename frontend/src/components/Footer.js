          ...
          <div className="col-lg-3 col-md-6 mb-5">
            <a href="" className="navbar-brand">
              <h1 className="text-primary">
                <span className="text-white">About </span>Nepal
              </h1>
            </a>
            <p>
              Nepal is a paradise for trekkers, nature lovers, and culture seekers, home to Mount Everest, ancient temples, and stunning landscapes. Perfect for adventure and exploration! 🏔️✨
            </p>
      ...
      >
        <div className="row">
          ...
          <div className="col-lg-6 text-center text-md-right">
            <p className="m-0 text-white-50">
              Designed by <a href="https://techgaun.com/">Tech Gaun</a>
            </p>
          </div>
        </div>
      </div>
